-- Выгрузка данных плейлиста в таблицу  Playlist_EveningBell  вер.2025-01-08
...
CREATE TABLE CurPlaylist(Id_DP INTEGER PRIMARY KEY ASC UNIQUE NOT NULL, Artist TEXT, Locale TEXT, Title TEXT, ArtSort TEXT, ArtCount INTEGER , AllCount INTEGER, EnRuCount INTEGER
	, NewTrack INTEGER , RealTime DATETIME  NOT NULL DEFAULT (STRFTIME('%Y-%m-%d %H:%M', 'NOW', 'localtime')));
...
--, GroupCount INTEGER, GroupStep INTEGER, ArtStep  INTEGER